...
namespace StrixIT.Platform.Modules.Cms.Tests
{
    ...
    public class ImageConverterTests
    {
        ...
        {
            var target = GetImageConverter();
            string path = Helpers.GetWorkingDirectory() + @"\TestFiles\Strix_losuiltje.png";
            int width = 100;
            int height = 100;
        ...
        {
            var target = GetImageConverter();
            string path = Helpers.GetWorkingDirectory() + @"\TestFiles\uiltje.png";
            string resultFile = Helpers.GetWorkingDirectory() + @"\TestFiles\uiltje_50_50.png";
        ...
        private ImageConverter GetImageConverter()
        {
            ...
            cultureMock.Setup(c => c.CurrentCultureCode).Returns("en");
            var userMock = new Mock<IUserContext>();
            userMock.Setup(u => u.IsInMainGroup).Returns(true);
            ...
            environmentMock.Setup(e => e.MapPath(It.IsAny<string>())).Returns<string>(s => s);
            environmentMock.Setup(e => e.WorkingDirectory).Returns(Helpers.GetWorkingDirectory());
            return new ImageConverter(environmentMock.Object);
        }
