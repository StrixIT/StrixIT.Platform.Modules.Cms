...
namespace StrixIT.Platform.Modules.Cms
{
    ...
    public interface IEntityService<TModel> : ICrudService<Guid, TModel> where TModel : EntityViewModel
    {
        ...
        /// <summary>
        /// Gets the content of the specified type for the entity with the specified id, for the
        /// specified culture and current version.
        /// </summary>
        ...
        /// <summary>
        /// Gets the content of the specified type for the entity with the specified id, for the
        /// specified culture and current version including the specified relations.
        /// </summary>
        /// <param name="id">The entity id</param>
        /// <param name="culture">The culture to get the content for</param>
        ...
        /// <summary>
        /// Gets the content of the specified type for the entity with the specified id, for the
        /// specified culture and specified version.
        /// </summary>
        /// <param name="id">The entity id</param>
        /// <param name="culture">The culture to get the content for</param>
        ...
        /// <summary>
        /// Gets the content of the specified type for the entity with the specified id, for the
        /// specified culture and specified version including the specified relations.
        /// </summary>
        /// <param name="id">The entity id</param>
        /// <param name="culture">The culture to get the content for</param>
        /// <param name="versionNumber">The version of the content to get</param>
        ...
        /// <summary>
        /// Gets the content of the specified type for the entity with the specified url, for the
        /// current culture and current version.
        /// </summary>
        ...
        /// <summary>
        /// Gets the content entity with the specified url, for the specified culture if available
        /// or any other culture otherwise, including the specified relations.
        /// </summary>
        /// <param name="url">The entity url</param>
        /// <param name="culture">The culture to get the content for</param>
        /// <param name="relationsToInclude">The relations to include</param>
        ...
        /// <summary>
        /// Gets cached content for the specified entity type with the specified url for the current
        /// culture and version.
        /// </summary>
        /// <param name="url">The entity url</param>
        /// <param name="permissionKey">
        /// An optional cache key to cache for a specific permission only
        /// </param>
        ...
        /// <summary>
        /// Deletes the content for the entity with the specified id for the specified culture from
        /// the data source.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the content for the entity with the specified id for the specified culture and
        /// version number from the data source.
        /// </summary>
        /// <param name="id">The id of the entity to delete or delete content for</param>
        /// <param name="culture">The culture to delete content for, when specified</param>
        ...
        /// <summary>
        /// Deletes the content for the entity with the specified id for the specified culture and
        /// version number from the data source. A message can be logged when the trash bin is active.
        /// </summary>
        /// <param name="id">The id of the entity to delete or delete content for</param>
        /// <param name="culture">The culture to delete content for, when specified</param>
        /// <param name="versionNumber">The content version to delete, when specified</param>
        ...
        /// <summary>
        /// Deletes the content for the entity with the specified id for the specified culture and
        /// version number from the data source. A message can be logged when the trash bin is
        /// active. When specified, the changes will be persisted to the data source.
        /// </summary>
        ...
        /// True if the delete should be persisted to the data source, false otherwise
        /// </param>
        ...
        /// <summary>
        /// Gets a list of entity version models for the specified entity for the specified culture
        /// using the data manager parameters.
        /// </summary>
        /// <param name="id">The entity id</param>
        ...
        /// <summary>
        /// Restores the version with the specified number for the specified entity, writing the
        /// message to the entity log.
        /// </summary>
        /// <param name="id">The entity id</param>
